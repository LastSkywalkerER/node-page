...
// Handler handles node join, invite, and connect HTTP requests.
type Handler struct {
	nodeService           Service
...
func (h *Handler) Connect(c *gin.Context) {
	...
	if err := Update(baseURL, joinResp.Data.NodeAccessToken); err != nil {
...
func (h *Handler) RegenerateAgentToken(c *gin.Context) {
...
func (h *Handler) GetClusterUIStatus(c *gin.Context) {
...
func (h *Handler) DeleteAgentClusterConfig(c *gin.Context) {
...
func (h *Handler) UpdateAgentClusterConfig(c *gin.Context) {
...
func (h *Handler) DeleteRemoteHost(c *gin.Context) {
	hostID, ok := parseHostIDParam(c)
	if !ok {
		return
	}
	...
	if err != nil {
		if errors.Is(err, ErrCannotDeleteLocalHost) {
