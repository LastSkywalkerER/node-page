...
func (a *appliers) applyGatewayRouteUpsert(cmd Command, _ *hraft.Log) error {
	...
	return a.deps.GatewayRepo.Upsert(ctx, &gateway.Route{
		...
		AddPrefix:                     p.AddPrefix,
		HostHeaderMode:                p.HostHeaderMode,
		HostHeaderValue:               p.HostHeaderValue,
		TargetServerName:              p.TargetServerName,
		ExtraTargets:                  p.ExtraTargets,
		...
		ForwardAuthResponseHeaders:    p.ForwardAuthResponseHeaders,
		ForwardAuthTrustForwardHeader: p.ForwardAuthTrustForwardHeader,
		SecurityHeaders:               p.SecurityHeaders,
		HSTS:                          p.HSTS,
		HSTSIncludeSubdomains:         p.HSTSIncludeSubdomains,
		Compress:                      p.Compress,
		RedirectURL:                   p.RedirectURL,
		RedirectPermanent:             p.RedirectPermanent,
		RedirectPreservePath:          p.RedirectPreservePath,
		Protocol:                      p.Protocol,
