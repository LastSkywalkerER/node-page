...
func (r *Replicator) SubmitGatewayRouteUpsert(ctx context.Context, g gateway.Route) error {
	...
	res, err := SubmitTyped(ctx, r.svc, CmdGatewayRouteUpsert, GatewayRouteUpsertPayload{
		...
		AddPrefix:                     g.AddPrefix,
		HostHeaderMode:                g.HostHeaderMode,
		HostHeaderValue:               g.HostHeaderValue,
		TargetServerName:              g.TargetServerName,
		ExtraTargets:                  g.ExtraTargets,
		...
		ForwardAuthURL:                g.ForwardAuthURL,
		ForwardAuthResponseHeaders:    g.ForwardAuthResponseHeaders,
		ForwardAuthTrustForwardHeader: g.ForwardAuthTrustForwardHeader,
		SecurityHeaders:               g.SecurityHeaders,
		HSTS:                          g.HSTS,
		HSTSIncludeSubdomains:         g.HSTSIncludeSubdomains,
		Compress:                      g.Compress,
		RedirectURL:                   g.RedirectURL,
		RedirectPermanent:             g.RedirectPermanent,
		RedirectPreservePath:          g.RedirectPreservePath,
		Protocol:                      g.Protocol,
